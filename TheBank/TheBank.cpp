...
//^^^Processtransaction se encarga de realizar una transacción en una cuenta bancaria. Para hacerlo, recibe informacion: 
//el número de cuenta (accnumber), la cantidad de dinero involucrada en la transaccion (amount) y el tipo de transaccion (transactionType), que puede ser deposit o withdraw.
...
//El tipo de transacción es withdraw, se ejecuta la segunda parte del bloque(it->withdraw(amount)), que realiza un retiro de la cuenta.
        } else {
            cout << "\n";
            cout << "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n";
